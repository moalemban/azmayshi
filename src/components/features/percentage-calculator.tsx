      ...
      <CardContent className="flex flex-col gap-4">
        <div className="flex gap-4 items-end">
          <div className="space-y-2 flex-1">
            ...
            <Input id="val1" type="number" value={val1} onChange={(e) => setVal1(e.target.value)} className="h-12 text-lg text-center"/>
          </div>
          <div className="space-y-2 flex-1">
            <Label htmlFor="val2">مقدار دوم</Label>
            <Input id="val2" type="number" value={val2} onChange={(e) => setVal2(e.target.value)} className="h-12 text-lg text-center" />
          </div>
        </div>
