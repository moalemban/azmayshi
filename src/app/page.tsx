        ...
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
                    ...
                    <div className="space-y-4 text-right leading-relaxed max-h-[70vh] overflow-y-auto p-1 pr-3">
                        ...
                        <div className="space-y-3">
                            <div>
                                ...
                                <p>تمام ابزارهای «تبدیلا» برای استفاده شخصی، آموزشی و قانونی طراحی شده‌اند. هرگونه استفاده تجاری، سوءاستفاده از سرویس‌ها (مانند ارسال درخواست‌های بیش از حد به ابزارهای هوش مصنوعی)، یا بارگذاری محتوای خلاف قوانین جمهوری اسلامی ایران، مجاز نیست.</p>
                            </div>
                            <div>
                                <h4 className="font-semibold text-foreground">۲. حقوق مالکیت فکری</h4>
                                <p>تمامی حقوق مادی و معنوی این وب‌سایت، شامل کدها، طراحی‌های گرافیکی، رابط کاربری، لوگو و محتوای متنی، متعلق به «تبدیلا» و توسعه‌دهنده آن است. هرگونه کپی‌برداری، مهندسی معکوس یا انتشار بدون کسب اجازه کتبی، پیگرد قانونی خواهد داشت.</p>
                            </div>
                            <div>
                                <h4 className="font-semibold text-foreground">۳. مسئولیت داده‌ها و نتایج</h4>
                                <p>اطلاعات و نتایج ارائه‌شده توسط ابزارها (به‌ویژه ابزارهای مالی، حقوقی و پزشکی) صرفاً جنبه اطلاع‌رسانی و کمکی دارند و نباید به عنوان توصیه تخصصی قطعی تلقی شوند. مسئولیت نهایی استفاده از این داده‌ها و هرگونه تصمیم‌گیری بر اساس آن‌ها، کاملاً بر عهده کاربر است.</p>
                            </div>
                             <div>
                                <h4 className="font-semibold text-foreground">۴. محدودیت خدمات</h4>
                                <p>«تبدیلا» حق دارد در هر زمان، خدمات خود را تغییر داده، محدود کرده یا به طور کامل متوقف کند. ما تمام تلاش خود را می‌کنیم تا این تغییرات از قبل اطلاع‌رسانی شوند، اما الزامی برای این کار وجود ندارد.</p>
                            </div>
                            <div>
                                <h4 className="font-semibold text-foreground">۵. تغییرات در قوانین</h4>
                                <p>این قوانین ممکن است در آینده به‌روزرسانی شوند. استفاده مستمر شما از وب‌سایت به منزله پذیرش آخرین نسخه قوانین خواهد بود.</p>
                            </div>
                        </div>
                    </div>
                </DialogContent>
            ...
            <Dialog>
                ...
                <DialogContent className="sm:max-w-[600px] glass-effect">
                    ...
                    <div className="space-y-4 text-right leading-relaxed max-h-[70vh] overflow-y-auto p-1 pr-3">
                        <p>حفظ حریم خصوصی شما برای ما در «تبدیلا» از بالاترین اهمیت برخوردار است. این سند نحوه جمع‌آوری و استفاده از اطلاعات شما را شفاف‌سازی می‌کند:</p>
                        <div className="space-y-3">
                            <div>
                                <h4 className="font-semibold text-foreground">۱. اطلاعاتی که جمع‌آوری می‌کنیم</h4>
                                <p>
                                    - **اطلاعات غیرشخصی:** ما ممکن است داده‌های آماری غیرقابل شناسایی مانند نوع مرورگر، سیستم‌عامل و ابزارهای استفاده‌شده را برای بهبود تجربه کاربری جمع‌آوری کنیم.
                                    <br/>
                                    - **محتوای ورودی:** متونی که در ابزارهایی مانند «خلاصه‌ساز» یا «چت‌بات» وارد می‌کنید، برای پردازش به سرویس‌دهندگان هوش مصنوعی (مانند Google AI) ارسال می‌شوند. ما این محتوا را در سرورهای خود ذخیره نمی‌کنیم.
                                    <br/>
                                     - **جلوگیری از سوءاستفاده:** برای جلوگیری از استفاده بی‌رویه از ابزارهای مبتنی بر هوش مصنوعی، ممکن است آدرس IP شما به صورت موقت و ناشناس برای اعمال محدودیت درخواست (Rate Limiting) استفاده شود.
                                </p>
                            </div>
                            <div>
                                <h4 className="font-semibold text-foreground">۲. کوکی‌ها</h4>
                                <p>«تبدیلا» از کوکی‌ها صرفاً برای ذخیره تنظیمات ظاهری شما (مانند تم روشن/تاریک) و به خاطر سپردن انتخاب‌های شما در داخل اپلیکیشن استفاده می‌کند. ما از کوکی‌ها برای ردیابی فعالیت‌های شما در خارج از این سایت استفاده نمی‌کنیم.</p>
                            </div>
                            <div>
                                <h4 className="font-semibold text-foreground">۳. امنیت داده‌ها</h4>
                                <p>تمامی ارتباطات شما با سرورهای «تبدیلا» از طریق پروتکل امن SSL/TLS رمزنگاری می‌شود. ما متعهد به حفاظت از داده‌های شما در برابر دسترسی‌های غیرمجاز هستیم.</p>
                            </div>
                             <div>
                                <h4 className="font-semibold text-foreground">۴. سرویس‌های شخص ثالث</h4>
                                <p>برخی از قابلیت‌های سایت توسط سرویس‌دهندگان معتبر ثالث ارائه می‌شوند (مانند Google AI برای قابلیت‌های هوشمند). داده‌های ارسالی به این سرویس‌ها، تابع قوانین حریم خصوصی آن شرکت‌ها خواهد بود. ما همواره از معتبرترین سرویس‌ها برای حفظ امنیت داده‌های شما استفاده می‌کنیم.</p>
                             </div>
                              <div>
                                <h4 className="font-semibold text-foreground">۵. شفافیت</h4>
                                <p>ما هیچ‌گونه اطلاعات شخصی قابل شناسایی (مانند نام، ایمیل، شماره تماس) را بدون اجازه و اطلاع مستقیم شما جمع‌آوری و ذخیره نمی‌کنیم. استفاده از ابزارهای ما کاملاً ناشناس است.</p>
                            </div>
                        </div>
                    </div>
                </DialogContent>
